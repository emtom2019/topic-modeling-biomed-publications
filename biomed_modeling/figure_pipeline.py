...
"""
The :mod:'figure_pipeline' module contains several functions that are useful for generating the a set of 
figures and spreadsheets for a given model and dataset.
"""
...
def run_pipeline(model_path, data_path, data_column, year_column, journal_column, year_start, year_res, year_end=None, pic_format='png', 
                main_path=None, docs=None, min_phi=1, num_topics=5, seed=2020, topic_names=None, topic_groups=None, max_journals=0):
    # Runs all of the functions and creates all of the figures and dataframes 
    """
    This function runs all of the other functions in this module in order and produces
    a set of figures and spreadsheets as results.

    Parameters
    ----------
    model_path : String of the relative path to the model to be used

    data_path : String of the relative path to the dataset

    data_column : String name of the column containing the data

    year_column : String name of the column containing the year

    journal_column : String name of the column containing the Journal
    
    year_start : integer of the first year in the dataset where you want to start the analysis

    year_res : integer step for the grouping of years

    year_end : integer of the last year in the dataset where you want to end the analysis. Default None

    pic_format : string of the file type for the final figures. Default 'png'

    main_path : folder where you want all of the results saved to. Default None = 'reports/main/'

    docs : int or list of int of the index numbers of the texts for which you want to display
        the topic analysis paragraph figure. Default None - This produces 1 random abstract figure

    min_phi : float or integer of the minimum association of words to topic to be highlighted 
        in the paragraph figure. Default 1

    num_topics : Maximum number of topics to display for the paragraph figure. Default 5
    
    seed : seed for the TSNE figure

    topic_names : dictionary of integer topic numbers to string topic names. Default None

    topic_groups : dictionary of string topic groups to list of topics in group. Default None
        This is for combining related topics into one group and analysing trends of groups of topics

    max_journals : integer number of maximum number of journals to display and run seperate analyses. 
        Default 0 - turns this off. 
        Note: You may want to run build_journal_df_figs() seperately since
        the pipeline function runs the build_figures_all_data() function first and that changes the 
        settings for matplotlib and causes the figures to have a different theme.
...
if __name__ == "__main__": # Runs script only if it is directly run
    ...
    # Example code of running the pipeline
    """
    ...
    # Example code of running building the journal figures seperately from the run_pipline() function
    """
    main_path='reports/main/'
    ...
    build_journal_df_figs(j_path, model, df, journal_column, data_column, year_column, 5, year_list,
                    year_start=1980, year_end=None, max_journals=6)
    """
